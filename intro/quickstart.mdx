...
<Card title="quick tip" icon="wand-magic-sparkles" color="#9333EA">
  for most servers, we recommend starting with the defend module for essential server protection, then gradually enabling other modules as your needs expand.
</Card> 