...
<Card title="important" icon="circle-exclamation" color="#FECACA">
  antinuke protection only works when enovuh has proper permissions. the bot needs administrator permissions or equivalent role permissions to properly protect your server.
</Card>

<Card title="did you know?" icon="lightbulb" color="#FEF3C7">
  enovuh's antinuke system uses proactive caching of your server's structure, allowing for faster response times and more effective recovery options after an attack attempt.
</Card> 