...
<Card title="did you know?" icon="lightbulb" color="#FEF3C7">
  the automod system works alongside enovuh's manual moderation tools, creating a comprehensive security system. manual actions also count toward automod thresholds.
</Card> 