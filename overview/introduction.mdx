...
<AccordionGroup>
  <Accordion title="protection & moderation">
    keep your server safe with anti-raid, anti-nuke, auto-moderation, and join
    gate systems. moderate effectively with comprehensive tools for warnings,
    timeout, ban, kick, and more.
  </Accordion>
  <Accordion title="music & entertainment">
    high-quality music playback from multiple sources including youtube,
    spotify, and soundcloud, with support for playlists, queues, and audio
    filters.
  </Accordion>
  <Accordion title="leveling & economy">
    reward active members with customizable xp systems, level roles, and economy
    features to keep your community engaged.
  </Accordion>
  <Accordion title="social integrations">
    connect with external platforms like spotify, last.fm, and other social
    media to enhance your server experience.
  </Accordion>
  <Accordion title="utility & information">
    access useful tools for server management, information lookup, translation,
