...
<Frame>
  <img src="https://enovuh.lol/images/antinuke-example.png" alt="antinuke protection in action" className="rounded-lg" />
</Frame>
...
<Card title="stay updated" icon="bell" color="#4B5563">
  antinuke features are regularly updated to counter new nuking techniques. join our [support server](https://discord.gg/enovuh) to stay informed about the latest security enhancements.
</Card> 